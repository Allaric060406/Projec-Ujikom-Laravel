                ...
                <div class="col-5 offset-1">
                    <form action="/inputimage" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="deskripsifoto"  value="{{old('deskripsifoto')}}" id="deskripsifoto" placeholder="add detailed Description" class="form-control rounded-xl  border-3 h-12 border-hidden focus:border-blue-400 ring-2 ring-blue-500 ring-offset-1 outline-blue-500  @error('nama') is-invalid @enderror">
                                <div class="invalid-feedback">
                                    @error('deskripsifoto')
                                       {{ $message }}
                                    @enderror
